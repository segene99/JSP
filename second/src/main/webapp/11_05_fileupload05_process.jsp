...
<body>
	<%
        ...
        if (contentType != null &&  contentType.toLowerCase().startsWith("multipart/")) {
			...
			Collection<Part> parts = req.getParts();//part라는 클래스 자료형으로 collection으로 열거를 해놓음
			
            for (Part part : parts) { //sublet 3.0 이상버젼만 parts 사용 가능
                ...
                if  (part.getHeader("Content-Disposition").contains("filename=")) {
                    ...
                    if (part.getSize() > 0) {
                        ...
                        out.print("File.separator : "+File.separator); //separator =  / or \
